...
class NavigationClient(Node):
    def __init__(self):
        ...
        self.target_points = {
            1: (-2.5, 3.0, 0.0),    # 目标点1 - 基地血量高时的第一个点
            2: (-1.5, 3.5, 0.0),    # 目标点2 - 基地血量高时的停留点
            3: (1.5, 2.0, 0.0),     # 目标点3 - 基地血量低时的第一个点
            4: (2.5, 2.5, 0.0),     # 目标点4 - 基地血量低时的停留点
            5: (0.0, 1.0, 0.0),     # 目标点5 - 从回血点返回后的中转点
            6: (-0.5, -0.5, 0.0)    # 回血点 - 用于回血和补给
        }
